...
## 📝 User Stories та Критерії прийомки (Acceptance Criteria для Jira)
...
#### **Критерії прийомки (AC):**
* **AC 1:** Обов'язкові для заповнення поля: Ім'я, Прізвище, Номер телефону (формат +380XXXXXXXXX), Дата народження.
...
* **Спеціальність:** [ Кардіологія (dropdown) ]
* **Лікар:** [ лікар Котенко М. Л. (dropdown) ]
* **Дата:** [ YYYY-MM-DD (calendar) ]
* **Доступний час:** ( 10:00 ) [ 10:30 ] [ 11:00 ] ( 11:30 )

**Дані пацієнта:**
1. **Ім'я:** [ Текст, обов'язкове ]
2. **Прізвище:** [ Текст, обов'язкове ]
3. **Телефон:** [ +380XXXXXXXXX, обов'язкове ]
4. **Дата народження:** [ ДД.ММ.РРРР, обов'язкове ]

[ Кнопка: ПІДТВЕРДИТИ ЗАПИС ]
